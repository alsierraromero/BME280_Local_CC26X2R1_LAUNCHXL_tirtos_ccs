...
package/cfg/BME280_pem4f.oem4f: export C_DIR=
package/cfg/BME280_pem4f.oem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
package/cfg/BME280_pem4f.oem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

package/cfg/BME280_pem4f.sem4f: | .interfaces
package/cfg/BME280_pem4f.sem4f: package/cfg/BME280_pem4f.c package/cfg/BME280_pem4f.mak
	@$(RM) $@.dep
	$(RM) $@
	@$(MSG) clem4f -n $< ...
...
package/cfg/BME280_pem4f.sem4f: export C_DIR=
package/cfg/BME280_pem4f.sem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
package/cfg/BME280_pem4f.sem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

clean,em4f ::
	-$(RM) package/cfg/BME280_pem4f.oem4f
	-$(RM) package/cfg/BME280_pem4f.sem4f

BME280.pem4f: package/cfg/BME280_pem4f.oem4f package/cfg/BME280_pem4f.mak

clean::
	-$(RM) package/cfg/BME280_pem4f.mak
